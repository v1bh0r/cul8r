Cul8r::Application.configure do
  ...
  config.assets.precompile += %w( gritter.js gritter.css bootstrap.css jquery-pageslide/jquery.pageslide.js jquery-pageslide/jquery.pageslide.css)
